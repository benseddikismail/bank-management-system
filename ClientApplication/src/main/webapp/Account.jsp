...
String qry = " select account_id,type,balance,Opening_Date from account inner join Customer_accounts on account.account_id= Customer_accounts.acc_id where cust_id="+ Login.CustomerID+" order by Opening_Date DESC";
ResultSet rst = stmt.executeQuery(qry);
out.println("<thead>");
out.println("<tr> <th scope=\"col\">Account Id</th> <th scope=\"col\">Account Type</th> <th scope=\"col\">Account Balance</th>  <th scope=\"col\">Opening Date</th></tr> </thead>");
